...
output "spoke2_aks_hub_zone_id" {
  description = "Resource ID of the hub management DNS zone for spoke-02 PE DNS (split-horizon). Pass this to the ASO PrivateEndpointsPrivateDnsZoneGroup manifest."
  value       = azurerm_private_dns_zone.spoke2_aks_hub.id
}
